...
import 'extracted_model.dart';
export 'extracted_model.dart';

class ExtractedWidget extends StatefulWidget {
  const ExtractedWidget({super.key});

  @override
  State<ExtractedWidget> createState() => _ExtractedWidgetState();
}

class _ExtractedWidgetState extends State<ExtractedWidget> {
  late ExtractedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExtractedModel());
              ...
              child: Column(
                ...
                children: [
                  Material(
                    ...
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 0.889,
                      height: 404.0,
